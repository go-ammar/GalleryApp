...
public class FullImageScrollAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private static final String TAG = "FullImageScrollAdapter";
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        Log.d(TAG, "onBindViewHolder: position "+ImagesArrayList.get(position));
        Log.d(TAG, "onBindViewHolder: holder "+holder);
        Log.d(TAG, "onBindViewHolder: uri "+imgUri);
